...
const translations = {
  ...
  sidebar: {
    ...
    advPerformance: { it: "Adv Performance", en: "Adv Performance" },
  ...
  maps: {
    ...
    analysisTitle: {
      it: "Analisi AI — confronto store",
      en: "AI analysis — store comparison",
    },
    analysisDescription: {
      it: "Seleziona da 2 a 6 schede e genera un confronto discorsivo su reputazione, affluenza, visibilità e azioni per scalare il local pack. Ancorato ai dati reali scrappati.",
      en: "Pick 2 to 6 listings and generate a discursive comparison on reputation, foot traffic, visibility and actions to climb the local pack. Grounded in the real scraped data.",
    },
    analysisModeLabel: { it: "Tipo di confronto", en: "Comparison type" },
    analysisModeCross: { it: "Brand diversi", en: "Different brands" },
    analysisModeCrossHint: {
      it: "Competitor a confronto: posizionamento, gap rating e volume review, chi possiede la Top 3.",
      en: "Competitors compared: positioning, rating and review-volume gaps, who owns the Top 3.",
    },
    analysisModeIntra: { it: "Stesso brand", en: "Same brand" },
    analysisModeIntraHint: {
      it: "Più location dello stesso brand: varianza fra punti vendita, anello debole, affluenza.",
    ...
    analysisSelectAllCap: {
      it: "Massimo 6: seleziono le prime 6 schede in classifica.",
      en: "Max 6: selecting the top 6 listings by rank.",
    },
    analysisTracked: { it: "Tracciato", en: "Tracked" },
    analysisHasTraffic: { it: "Affluenza ✓", en: "Foot traffic ✓" },
    analysisIntraNoBrandHint: {
      it: "Nessuna di queste schede è stata abbinata automaticamente a un brand che monitori. Va bene così: per il confronto «stesso brand» seleziona manualmente le location che sai appartenere allo stesso marchio.",
      en: "None of these listings was auto-matched to a brand you track. That's fine — for a same-brand comparison just select the locations you know belong to the same brand.",
    },
    analysisModelLabel: { it: "Modello", en: "Model" },
    analysisNoModels: { it: "Nessun modello attivo", en: "No active model" },
    analysisCost: { it: "Costo", en: "Cost" },
    analysisCredit: { it: "credito", en: "credit" },
    analysisCredits: { it: "crediti", en: "credits" },
    analysisGenerate: { it: "Genera analisi", en: "Generate analysis" },
    analysisRegenerate: { it: "Rigenera", en: "Regenerate" },
    analysisMinTwo: {
      it: "Seleziona almeno 2 schede per generare il confronto.",
      en: "Select at least 2 listings to generate the comparison.",
    },
    analysisInsufficientCredits: {
    ...
    analysisDone: { it: "Analisi generata", en: "Analysis generated" },
    analysisServedCache: {
      it: "Analisi recuperata dalla cache (nessun addebito)",
      en: "Analysis served from cache (no charge)",
    },
    analysisCachedNote: {
      it: "Servito dalla cache",
      en: "Served from cache",
    },
    analysisSec_overview: { it: "Quadro d'insieme", en: "Big picture" },
    analysisSec_reputation: { it: "Reputazione", en: "Reputation" },
    analysisSec_footTraffic: { it: "Affluenza", en: "Foot traffic" },
    analysisSec_visibility: { it: "Visibilità e Local SEO", en: "Visibility & Local SEO" },
    analysisSec_recommendations: { it: "Raccomandazioni", en: "Recommendations" },
    factsStore: { it: "Scheda", en: "Listing" },
    factsRank: { it: "Pos.", en: "Rank" },
    factsRating: { it: "Rating", en: "Rating" },
    factsReviews: { it: "Review", en: "Reviews" },
    factsOwner: { it: "Risposte", en: "Replies" },
    factsPeak: { it: "Affluenza", en: "Busyness" },
  },
  ...
  // ─── Adv Performance (first-party campaign analytics) ────────
  // Migration 0040 (2026-05-08).
  advPerformance: {
    ...
    noClientsBody: {
      it: "Le performance vengono caricate per cliente. Crea prima un cliente in Brands → cliente.",
      en: "Performance data is uploaded per client. Create a client first in Brands → client.",
    },
    clientImportsCount: {
      it: "{n} import",
      en: "{n} import",
    ...
    uploadModeLabel: { it: "Come salvare", en: "How to save" },
    uploadModeAppend: {
      it: "Aggiungi come nuovo periodo",
      en: "Append as new period",
    },
    uploadModeAppendHint: {
      it: "Mantiene gli upload precedenti. Default consigliato.",
      en: "Keeps previous uploads. Recommended default.",
    },
    uploadModeReplace: {
      it: "Sostituisci esistente",
      en: "Replace existing",
    },
    uploadModeReplaceHint: {
      it: "Rimuove gli import precedenti che si sovrappongono al nuovo periodo.",
      en: "Removes previous imports that overlap with the new period.",
    },
    uploadValidate: { it: "Valida file", en: "Validate file" },
    uploadValidating: { it: "Validazione…", en: "Validating…" },
    uploadConfirm: { it: "Conferma e salva", en: "Confirm and save" },
    uploadSaving: { it: "Salvataggio…", en: "Saving…" },
    uploadCancel: { it: "Annulla", en: "Cancel" },
    uploadReupload: { it: "Carica un altro file", en: "Upload another file" },
    diagnosticsTitle: { it: "Diagnostica", en: "Diagnostics" },
    diagnosticsAllOk: {
      it: "File OK, nessun problema rilevato.",
      en: "File OK, no issues found.",
    },
    summaryTitle: { it: "Anteprima", en: "Preview" },
    summaryRows: { it: "Righe", en: "Rows" },
    summaryCampaigns: { it: "Campagne", en: "Campaigns" },
    summaryDateRange: { it: "Periodo", en: "Date range" },
    summaryTotalSpend: { it: "Spesa totale", en: "Total spend" },
    summaryCurrency: { it: "Valuta", en: "Currency" },
    deleteImportConfirm: {
      it: "Eliminare questo import? I dati persistiti e il file caricato saranno rimossi.",
      en: "Delete this import? Persisted data and uploaded file will be removed.",
    },
    deleteImportError: { it: "Errore nell'eliminazione.", en: "Error while deleting." },
    deleted: { it: "Import eliminato.", en: "Import deleted." },
    saved: { it: "Import salvato.", en: "Import saved." },
    // Channels
    channelMeta: { it: "Meta", en: "Meta" },
    channelGoogle: { it: "Google", en: "Google" },
    channelTiktok: { it: "TikTok", en: "TikTok" },
    channelSnapchat: { it: "Snapchat", en: "Snapchat" },
    comingSoon: { it: "presto disponibile", en: "coming soon" },
    // Dashboard
    ...
    kpiResults: { it: "Risultati", en: "Results" },
    ...
    campaignTypesDescription: {
      ...
      en: "Auto-decoded from the campaign name (VC = View Content, ATC = Add to Cart, PUR = Purchase, etc). Results and CPR are computed per type. Verify and override if needed.",
    },
    editMapping: { it: "Modifica mappatura", en: "Edit mapping" },
    editMappingHint: {
      it: "Per ogni campagna, conferma o correggi la tipologia decodificata. Quelle non riconosciute appariranno come 'Unknown' fino a che non le mappi.",
      en: "For each campaign, confirm or override the decoded type. Unrecognised ones will appear as 'Unknown' until mapped.",
    },
    saveOverrides: { it: "Salva", en: "Save" },
    campaignTypesSaved: { it: "Mappatura aggiornata.", en: "Mapping updated." },
    campaignName: { it: "Campagna", en: "Campaign" },
    decodedAs: { it: "Decodificata", en: "Decoded as" },
    overrideTo: { it: "Modifica in", en: "Override to" },
    notDecoded: { it: "Non riconosciuta", en: "Not decoded" },
    ctType: { it: "Tipo", en: "Type" },
    ctCampaigns: { it: "Campagne", en: "Campaigns" },
    ctSpend: { it: "Spesa", en: "Spend" },
    ctResults: { it: "Risultati", en: "Results" },
    ctCpr: { it: "CPR", en: "CPR" },
    deltaImproved: { it: "in miglioramento", en: "improved" },
    deltaWorsened: { it: "in peggioramento", en: "worsened" },
    deltaUnchanged: { it: "invariato", en: "unchanged" },
    noComparisonData: {
      it: "Nessun dato per il periodo di confronto selezionato.",
      en: "No data for the selected comparison period.",
    },
  },
  ...
  organic: {
    ...
    followers: { it: "Follower", en: "Followers" },
    followersPerBrand: { it: "Follower per brand", en: "Followers per brand" },
    totalFollowers: { it: "Follower totali", en: "Total followers" },
