...
const translations = {
  ...
  maps: {
    ...
    analysisIntraNoBrandHint: {
      it: "Nessuna scheda matcha un competitor tracciato: il confronto \"stesso brand\" è comunque valido se selezioni location che sai appartenere allo stesso marchio.",
      en: "No listing matches a tracked competitor: the \"same brand\" comparison still works if you pick locations you know belong to the same brand.",
    },
