        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex gap-2 flex-wrap">
              {([
                { key: "meta" as const, label: "Meta Ads", icon: <svg viewBox="0 0 24 24" fill="currentColor" className="size-4"><path d="M12 2.04c-5.5 0-10 4.49-10 10.02 0 5 3.66 9.15 8.44 9.9v-7H7.9v-2.9h2.54V9.85c0-2.52 1.49-3.93 3.78-3.93 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.78-1.63 1.57v1.88h2.78l-.45 2.9h-2.33v7A10 10 0 0 0 22 12.06C22 6.53 17.5 2.04 12 2.04Z" /></svg> },
                ...
                { key: "all" as const, label: t("compare", "allChannels"), icon: null },
              ]).map((ch) => {
