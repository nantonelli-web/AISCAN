...
export default async function CompetitorsPage() {
  ...
  const [
    ...
    supabase
      ...
      .select("id, workspace_id, client_id, page_name, page_id, page_url, category, country, instagram_username, snapchat_handle, tiktok_username, youtube_channel_url, google_advertiser_id, google_domain, profile_picture_url, monitor_config, last_scraped_at, created_at")
