  ...
  const paidTools: Tool[] = [
    {
      ...
      iconNode: <MetaIcon className="size-6" colored />,
      count: metaCount ?? 0,
  ...
  const organicTools: Tool[] = [
    {
      ...
      iconNode: <InstagramIcon className="size-6" colored />,
    ...
    },
    {
      ...
      iconNode: <TikTokIcon className="size-6" colored />,
      count: tiktokCount ?? 0,
      countLabel: t("monitoring", "postsCountLabel"),
    },
    {
      ...
      iconNode: <SnapchatIcon className="size-6" colored />,
    ...
    },
    {
      ...
      iconNode: <YouTubeIcon className="size-6" colored />,
